...
export const SecondaryCard = ({socialNetwork = 'Facebook', nameStats = 'Likes', countStats = 87, isUp = true, percentageUpOrDown = 0}) => {
  ...
  return (
    <div className="SecondaryCard">
      <div className="secondaryCard__statsWithText">
        ...
        <span className="secondaryCard__statsWithText--count">{countStats}</span>
      </div>
